...
console.log(JSON.stringify({ symbol, results, sameTimestampPriceConflicts: conflicts,
  note: "Separate requests can observe different trades. This checks price/time integrity and chart agreement, not simultaneous physical-device rendering." }, null, 2));
