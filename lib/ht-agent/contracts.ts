...
export const HT_AGENT_VISUAL_PLAN_VERSION = "agent-x-visual-paper-plan-v2" as const;
export const HT_AGENT_VISUAL_PLAN_POLICY_VERSION = "agent-x-visual-plan-expiry-v1-15-provider-minutes" as const;
export const HT_AGENT_VISUAL_PLAN_RISK_REWARD_VERSION = "agent-x-risk-reward-v1-least-favorable-entry" as const;
export const HT_AGENT_VISUAL_PLAN_CANCELLATION_VERSION = "agent-x-cancellation-v1-provider-minute" as const;
export const HT_AGENT_VISUAL_PLAN_API_VERSION = "agent-x-visual-plan-api-v2" as const;
