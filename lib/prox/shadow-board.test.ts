...
function candidate(index: number, qualified = true) {
  return {
    ...
    edge: {
      ...
      researchChallenger: {
        version: "prox-edge-theory-challenger-v1" as const,
        mode: "prospective_shadow_research_only" as const,
        score: 70,
        continuationEstimate: 70,
        rewardRiskAsymmetry: 75,
        evidenceConfidence: 70,
        riskPenalty: 0,
