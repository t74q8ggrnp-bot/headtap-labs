export default function TradeWorkspaceLoading() {
  return (
    <main className="min-h-screen w-full overflow-x-clip bg-[#050607] pb-[calc(env(safe-area-inset-bottom,0px)+1rem)] pl-[calc(env(safe-area-inset-left,0px)+0.5rem)] pr-[calc(env(safe-area-inset-right,0px)+0.5rem)] pt-[calc(env(safe-area-inset-top,0px)+0.5rem)] text-white sm:pl-[calc(env(safe-area-inset-left,0px)+0.75rem)] sm:pr-[calc(env(safe-area-inset-right,0px)+0.75rem)] sm:pt-[calc(env(safe-area-inset-top,0px)+0.75rem)] md:pb-[calc(env(safe-area-inset-bottom,0px)+2rem)] md:pl-[calc(env(safe-area-inset-left,0px)+1.25rem)] md:pr-[calc(env(safe-area-inset-right,0px)+1.25rem)] md:pt-[calc(env(safe-area-inset-top,0px)+1.25rem)]" role="status" aria-live="polite" aria-label="Loading Trading Workspace">
      <span className="sr-only">Loading the Trading Workspace and verified market context…</span>
