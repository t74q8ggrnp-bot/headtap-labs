...
export default function LegalDocument({
  ...
  return (
    <main className="ht-phase25-route ht-account-route ht-legal-route min-h-screen bg-[#050505] px-5 pb-28 pt-8 text-white sm:px-8 sm:py-12" data-route-audience="account">
      <div className="mx-auto max-w-4xl">
        ...
        <article className="ht-legal-document overflow-hidden rounded-[2rem] border border-orange-400/15 bg-zinc-950 shadow-2xl shadow-orange-950/20">
          <header className="ht-legal-document__header border-b border-white/10 px-6 py-9 sm:px-10 sm:py-12">
          ...
          <div className="ht-legal-document__body space-y-9 px-6 py-9 text-sm leading-7 text-zinc-300 sm:px-10 sm:py-12 [&_a]:font-bold [&_a]:text-orange-300 [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mb-3 [&_h2]:text-xl [&_h2]:font-black [&_h2]:text-white [&_li]:pl-1 [&_p+p]:mt-3 [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5">
            {children}
          </div>
        </article>
      </div>
